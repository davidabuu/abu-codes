...
const experiences = [
  ...
  },
  {
    ...
    responsibilities: [
      ...
      "Implemented granular role-based access control and an audit-ready admin console — turning a paper-driven process into a self-service portal that speeds resolution across federal MDAs.",
      "Launched an online resident-dues payment product with automated onboarding and real-time analytics dashboards — built the frontend for administrators to access live, actionable visibility into reports and surveys in place of spreadsheet-era reporting."
    ]
  },
  {
    role: "Senior Software Engineer",
    company: "EstateHub (Side Project)",
    period: "2026",
    responsibilities: [
      "Built a full‑stack microservices platform that replaces spreadsheets and WhatsApp with a unified estate‑management system for managers, residents, and admins — automating dues tracking, resident onboarding, and payment collection.",
      "Architected a .NET 8 microservices system using Clean Architecture, CQRS, and event‑driven communication (MassTransit + RabbitMQ) with Paystack integration for idempotent webhook‑based payments and automated email notifications.",
      "Deployed containerized services to Azure Container Apps behind a YARP API Gateway with centralized JWT authentication and rate limiting — giving estate managers real‑time visibility into dues, payments, and resident activity."
    ]
  },
  {
